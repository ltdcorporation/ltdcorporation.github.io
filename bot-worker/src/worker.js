...
function helpOverview() {
  return [
    'Cheatsheet Admin (versi santai):',
    '',
    'Channel (tombol link):',
    '- /setcopylist channels link1 | link2 | ...  -> ketik semua link urut dari kiri ke kanan. Contoh: /setcopylist channels https://t.me/ltddev | https://t.me/lusttodeath',
    '- /setcopylist channelNames nama1 | nama2    -> kasih label tombol sesuai urutan link.',
    '- /setcopylist channels default              -> balik ke urutan bawaan (main link + mirrors).',
    '',
    'Status & pengumuman:',
    '- /status teks status baru      -> update teks status hijau di atas.',
    '- /update pengumuman baru       -> tambah notifikasi, timestamp WIB otomatis.',
    '- /updates                      -> liat daftar pengumuman + nomor urut.',
    '- /editupdate nomor teks baru   -> contoh: /editupdate 2 Bot sudah normal.',
    '- /delupdate nomor              -> contoh: /delupdate 3 buat hapus entry ke-3.',
    '',
    'Copy landing page (teks bawaan):',
    '- /showcopy                     -> liat daftar nama field (ageTitle, footer, dst).',
    '- /setcopy namaField teks baru  -> contoh: /setcopy legalTitle Legal / 18+. Ketik default atau - buat reset.',
    '- /setcopylist namaField item1 | item2 | ... -> buat list kaya taglines/joinSteps. Pisah pake tanda |. Ketik default atau - buat reset.',
    '',
    'Bot resmi:',
    '- /addbot https://t.me/namabot  -> masukin bot ke halaman.',
    '- /delbot nomor                -> hapus bot sesuai nomor di /show.',
    '',
    'Monitoring:',
    '- /show -> ringkasan link utama, channel, bot, update terakhir.',
